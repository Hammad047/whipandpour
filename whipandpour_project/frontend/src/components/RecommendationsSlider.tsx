...
export default function RecommendationsSlider({
  ...
  return (
    <div className="recommendations-slider-section py-12 border-t border-[#E8DDD0]">
      ...
      >
        {products.map((product) => (
          <SwiperSlide key={product.id}>
            {/* Use button instead of Link to avoid nested <a> */}
            <button
              onClick={() => navigate(`/product/${product.slug}`)}
              className="product-card group cursor-pointer w-full text-left"
            >
              {/* Image Container */}
      ...
      <style>{`
        .recommendations-slider-section { width: 100%; }
        /* Swiper core */
        ...
        .recommendations-swiper { width: 100%; padding: 20px 0 50px; }
